...
## Problem 2
In this problem, I will analyze data gathered to understand the effects of several variables on a child’s birthweight. This dataset, available here, consists of roughly 4000 children and includes the variables specified in the homework instructions.
...
```{r}
# Model Fitting
bwt = lm(bwt ~ fincome + mrace, data = children)
...
# Diagnostics
modelr::add_residuals(children, bwt)

modelr::add_predictions(children, bwt)
